...
class StuffController extends Controller
{
    ...
    {
        $stuffs = Stuff::all();
        return view('unit.stuff.index')->with(['stuffs' => $stuffs]);
    }
    ...
    public function create()
    {
        ...
        return view('unit.stuff.create')->with(['programs' => $programs, 'categories' => $categories]);
    ...
    public function edit($id)
    {
        ...
        return view('unit.stuff.edit')->with(['stuff'=> $stuff, 'programs' => $programs, 'categories' => $categories]);
