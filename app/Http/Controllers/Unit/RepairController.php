...
class RepairController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('unit.repair.index')->with(['repairs' => $repairs]);
    }
    ...
    public function create()
    {
        ...
        return view('unit.repair.create')->with(['items' => $items]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('unit.repair.edit')->with(['repair' => $repair]);
    }
    ...
    {
        $repairs = Repair::all();
        return view('unit.repair.back')->with(['repairs' => $repairs]);
    }
