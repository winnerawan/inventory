                ...
                <div class="col-lg-12">
                    <div class="card card-outline-info">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white">Form Edit Program Studi</h4>
                        </div>
                        <div class="card-body">
                            {!! Form::model($program, ['route' => ['program.update', $program->id], 'method' => 'PUT', 'files' => true]) !!}                            <div class="form-group">
                                <div class="form-body">
                                    ...
                                    {{--<div class="row">--}}
                                        {{--<div class="col-md-6">--}}
                                            {{--<div class="form-group has-success">--}}
                                                ...
                                                {{--{{ Form::text('location', null, array('class' => 'form-control', 'required' => '', 'maxlength' => '255')) }}                                            </div>--}}
                                        {{--</div>--}}
