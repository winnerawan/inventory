...
<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        ...
        <div class="user-profile">
            {{--<!-- User profile image -->--}}
            {{--<div class="profile-img"> <img src="{{ asset("unit/assets/images/users/profile.png") }}" alt="user" />--}}
            ...
            <ul id="sidebarnav">
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Kategori</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{ url('unit/category') }}">Data Kategori</a></li>
                        <li><a href="{{ url('unit/category/create') }}">Tambah Kategori</a></li>
                    </ul>
                </li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-widgets"></i><span class="hide-menu">Master Barang</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{ url('unit/stuff') }}">Master Barang</a></li>
                        <li><a href="{{ url('unit/stuff/create') }}">Tambah Master Barang</a></li>
                    </ul>
                </li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-widgets"></i><span class="hide-menu">Barang</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{ url('unit/item') }}">Detail Barang</a></li>
                        <li><a href="{{ url('unit/item/create') }}">Tambah Barang</a></li>
                    </ul>
                </li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Perbaikan</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{ url('unit/repair') }}">Data Perbaikan</a></li>
                        <li><a href="{{ url('unit/repair/create') }}">Tambah Perbaikan</a></li>
                        <li><a href="{{ url('unit/repairback') }}">Pengembalian Perbaikan</a></li>
                    </ul>
                </li>
                ...
                {{--<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Pengadaan</span></a>--}}
                    {{--<ul aria-expanded="false" class="collapse">--}}
                        {{--<li><a href="{{ url('unit/make') }}">Data Pengadaan</a></li>--}}
                        {{--<li><a href="{{ url('unit/make/create') }}">Tambah Pengadaan</a></li>--}}
                    {{--</ul>--}}
                {{--</li>--}}
                ...
                {{--<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Peminjaman</span></a>--}}
                    {{--<ul aria-expanded="false" class="collapse">--}}
                        {{--<li><a href="{{ url('unit/borrow') }}">Data Peminjaman</a></li>--}}
                        {{--<li><a href="{{ url('unit/borrow/create') }}">Tambah Peminjaman</a></li>--}}
                        {{--<li><a href="{{ url('unit/loan/back') }}">Pengembalian Peminjaman</a></li>--}}
                    {{--</ul>--}}
                {{--</li>--}}
